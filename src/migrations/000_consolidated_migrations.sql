...
CREATE TABLE IF NOT EXISTS attendance (
  ...
  bulk_advance_taken DECIMAL(10, 2) DEFAULT 0,
  bulk_advance_paid DECIMAL(10, 2) DEFAULT 0,
  bulk_advance DECIMAL(10, 2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS catering_details (
  ...
  morning_food_count INTEGER DEFAULT 0,
  afternoon_food_menu TEXT,
  afternoon_food_count INTEGER DEFAULT 0,
  evening_food_menu TEXT,
  evening_food_count INTEGER DEFAULT 0,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS expense_details (
  ...
  cleaning_bill DECIMAL(10, 2) DEFAULT 0,
  grocery_bill DECIMAL(10, 2) DEFAULT 0,
  vegetable_bill DECIMAL(10, 2) DEFAULT 0,
  cylinder_amount DECIMAL(10, 2) DEFAULT 0,
  morning_food_expense DECIMAL(10, 2) DEFAULT 0,
  afternoon_food_expense DECIMAL(10, 2) DEFAULT 0,
  evening_food_expense DECIMAL(10, 2) DEFAULT 0,
  vehicle_expense DECIMAL(10, 2) DEFAULT 0,
  packing_items_charge DECIMAL(10, 2) DEFAULT 0,
  details TEXT,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS overall_stock (
  ...
  new_stock_date DATE,
  unit VARCHAR(20) CHECK (unit IN ('gram', 'kg', 'Litre', 'pieces', 'Boxes') OR unit IS NULL),
  remaining_stock_gram DECIMAL(10, 2) DEFAULT 0,
  remaining_stock_kg DECIMAL(10, 2) DEFAULT 0,
  remaining_stock_litre DECIMAL(10, 2) DEFAULT 0,
  remaining_stock_pieces DECIMAL(10, 2) DEFAULT 0,
  remaining_stock_boxes DECIMAL(10, 2) DEFAULT 0,
  new_stock_gram DECIMAL(10, 2) DEFAULT 0,
  new_stock_kg DECIMAL(10, 2) DEFAULT 0,
  new_stock_litre DECIMAL(10, 2) DEFAULT 0,
  new_stock_pieces DECIMAL(10, 2) DEFAULT 0,
  new_stock_boxes DECIMAL(10, 2) DEFAULT 0,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  UNIQUE(item_id)
);
...
CREATE TABLE IF NOT EXISTS sales_details (
  ...
  details TEXT,
  company_staff BOOLEAN DEFAULT FALSE,
...
-- 28. DAILY MINING ACTIVITIES TABLE
CREATE TABLE IF NOT EXISTS daily_mining_activities (
  id SERIAL PRIMARY KEY,
  activity_id INTEGER NOT NULL REFERENCES mining_activities(id) ON DELETE CASCADE,
  date DATE NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_credit_details_company_staff ON credit_details(company_staff) WHERE company_staff IS NOT NULL;

-- Vehicle licenses indexes
...
CREATE INDEX IF NOT EXISTS idx_sales_details_company_staff ON sales_details(company_staff) WHERE company_staff IS NOT NULL;
...
-- Company purchase details indexes
...
-- Mining activities indexes
CREATE INDEX IF NOT EXISTS idx_mining_activities_sector ON mining_activities(sector_code);
CREATE INDEX IF NOT EXISTS idx_daily_mining_activities_activity ON daily_mining_activities(activity_id);
CREATE INDEX IF NOT EXISTS idx_daily_mining_activities_date ON daily_mining_activities(date);

-- ============================================
-- PART 3: DEFAULT DATA (Migration 002)
-- ============================================
