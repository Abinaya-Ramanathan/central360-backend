...
import mahalVesselsRouter from './routes/mahal_vessels.routes.js';
...
import itemNamesRouter from './routes/item_names.routes.js';
import itemPricesRouter from './routes/item_prices.routes.js';
...
app.use('/api/v1/mahal-vessels', mahalVesselsRouter);
...
app.use('/api/v1/item-names', itemNamesRouter);
app.use('/api/v1/item-prices', itemPricesRouter);
